    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Analyzing Your Farm</h2>
          <p className="text-gray-600">AI is generating personalized crop recommendations...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Unable to Get Recommendations</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <p className="text-gray-600">Unable to generate recommendations for your farm conditions.</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-white/10 rounded-xl p-4 text-center">
                ...
                <p className="text-white font-bold">{recommendations.weather_data?.description || 'N/A'}</p>
                <p className="text-green-200 text-sm">{recommendations.weather_data?.location}</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <ThermometerSun className="w-8 h-8 text-white mx-auto mb-2" />
                <p className="text-green-100 text-sm">Temperature</p>
                <p className="text-white font-bold">{recommendations.weather_data?.temperature}°C</p>
                <p className="text-green-200 text-sm">Humidity: {recommendations.weather_data?.humidity}%</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <Leaf className="w-8 h-8 text-white mx-auto mb-2" />
                <p className="text-green-100 text-sm">Soil Analysis</p>
                <p className="text-white font-bold">{recommendations.soil_analysis?.type}</p>
                <p className="text-green-200 text-sm">pH: {recommendations.soil_analysis?.pH}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Rank #{crop.rank}</p>
                        </div>
                      </div>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-semibold">{crop.confidence.toFixed(1)}%</span>
                      </div>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="font-semibold text-gray-800">Expected Income</span>
                      </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-green-50 p-4 rounded-xl">
                    <h4 className="font-semibold text-green-800 mb-2">Confidence Score</h4>
                    <p className="text-2xl font-bold text-green-600">
                      {selectedPopup.crop.confidence.toFixed(1)}%
                    </p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-xl">
                    <h4 className="font-semibold text-blue-800 mb-2">Expected Income</h4>
                ...
                <div className="bg-gray-50 p-4 rounded-xl">
                  ...
                  <p className="text-gray-600">
                    Based on your soil type ({recommendations?.soil_analysis?.type}), 
                    current weather conditions ({recommendations?.weather_data?.temperature}°C, {recommendations?.weather_data?.humidity}% humidity), 
                    and farm size ({farmData.farmSize}), this crop shows high compatibility and profit potential.
                  </p>
                </div>

                <div className="bg-yellow-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-yellow-800 mb-2">Soil Nutrients</h4>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center">
                      <p className="text-sm text-gray-600">Nitrogen</p>
                      <p className="font-bold">{recommendations?.soil_analysis?.N}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm text-gray-600">Phosphorus</p>
                      <p className="font-bold">{recommendations?.soil_analysis?.P}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm text-gray-600">Potassium</p>
                      <p className="font-bold">{recommendations?.soil_analysis?.K}</p>
                    </div>
                  </div>
                </div>
              </div>
