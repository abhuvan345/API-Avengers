...
const FarmDetailsPage: React.FC<FarmDetailsPageProps> = ({
  ...
  const popularLocations = [
    ...
    "Pune", "Ahmedabad", "Jaipur", "Lucknow", "Nashik", "Solapur", 
    "Aurangabad", "Nagpur", "Indore", "Bhopal", "Coimbatore", "Madurai",
    "Vijayawada", "Visakhapatnam", "Guntur", "Rajkot", "Surat", "Vadodara"
  ];
          ...
          <form onSubmit={handleSubmit} className="p-8">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-600 mb-2">Popular agricultural regions:</p>
